...
////20100826 modify by cuizf for this.sParent.offsetHeight  --->  parseInt(this.sParent.style.height)
	this.sParentHeight = parseInt(this.sParent.style.height);
	this.sParentWidth = parseInt(this.sParent.style.width);	
	// this.sParentHeight = parseInt(this.sParent.offsetHeight);
	// this.sParentWidth = parseInt(this.sParent.offsetWidth);
